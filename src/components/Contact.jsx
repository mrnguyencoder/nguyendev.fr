      ...
      <div className="relative bg-slate-900 shadow-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div className="relative overflow-hidden bg-slate-700 py-10 px-6 sm:px-10 xl:p-12 rounded-2xl m-3">
            ...
            <dl className="mt-8 space-y-6">
              ...
              <dd className="flex text-base text-indigo-50">
                ...
                <span className="ml-3">+33- 7 82 88 52 24</span>
              </dd>
              <dt>
              ...
              <dd className="flex text-base text-indigo-50">
                ...
                <span className="ml-3">mr.nguyencoder@gmail.com</span>
              </dd>
            </dl>
          ...
          <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
            <h3 className="text-lg font-medium text-gray-50">Send us a message</h3>
            <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="block w-full rounded-md border-gray-300 py-3 px-4 text-gray-50 shadow-sm focus:border-[#F0DB4F] focus:ring-[#F0DB4F]"
                  />
                </div>
              </div>
              <div>
              ...
              <div className="sm:col-span-2 sm:flex sm:justify-end">
                <button
                  type="submit"
                  className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-[#61dbfb] px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-[#F0DB4F] focus:outline-none focus:ring-2 focus:ring-[#F0DB4F] focus:ring-offset-2 sm:w-auto"
                >
                  Submit
                </button>
              </div>
